...
const BannerElementor = () => {
  ...
  const handleSave = async () => {
    ...
    const existingBanner = isNewBanner ? null : filledBanners[activeIndex];
    ...
    if (layout === "layout2") {
      return (
        ...
        >
          ...
          {/* Cards — using title1-5 and desc1-4 */}
              ...
              <div className="relative bg-white py-3 rounded-xl w-auto max-w-[95%] md::max-w-[900px]">
                ...
                {selectedLayout === "layout2" && (
                  <div className="max-h-[75vh] overflow-y-auto p-5">
                    ...
                    <div className="mt-4">
                      <p className="text-xs font-semibold text-indigo-800 mb-2">
                        Descriptions (shown below titles)
                      </p>
