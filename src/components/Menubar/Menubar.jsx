          ...
          <li key={index}>
            {item.to ? (
              <Link
                ...
                className={`flex items-center p-2 rounded-md hover:bg-white hover:text-black transition-all duration-300 overflow-hidden ${
                  location.pathname === item.to ||
                  // Universities active state
                  (item.to === "/Universities" &&
                    (location.pathname.startsWith("/EditUniversityElementor") ||
                      location.pathname === "/AddUniversityElementor")) ||
                  // Office Data active state
                  (item.to === "/office" &&
                    (location.pathname.startsWith("/edit-office") ||
                      location.pathname === "/OfficePageElementor")) ||
                  // Exam Data active state
                  (item.to === "/exam" &&
                    (location.pathname.startsWith("/edit-exam-page") ||
                      location.pathname === "/ExamPageElementor"))
                    ? "bg-white text-black"
                    : ""
                }`}
              ...
              >
                ...
                <span
                  className={`font-medium transition-all duration-500 whitespace-nowrap overflow-hidden ${
                    isOpen ? "ml-4 opacity-100" : "ml-0 opacity-0 w-0"
                  }`}
                >
                  {item.text}
                </span>
              ...
              <button
                onClick={item.action}
                className="flex items-center p-2 rounded-md hover:bg-white hover:text-black transition-all duration-300 w-full text-left overflow-hidden"
              >
                <span className="text-xl">{item.icon}</span>
                <span
